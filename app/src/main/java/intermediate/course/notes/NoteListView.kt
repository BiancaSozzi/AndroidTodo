...
class NoteListView @JvmOverloads constructor(
    ...
    fun initView(taDelegate: NotesListFragment.TouchActionDelegate, noDelegate: NoteListViewContract){
        setUpDelegates(taDelegate, noDelegate)
        setUpView()
    }

    private fun setUpDelegates(taDelegate: NotesListFragment.TouchActionDelegate, noDelegate: NoteListViewContract){
